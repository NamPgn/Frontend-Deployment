import{u as Ct,a as Nt,b as We,c as p,d as B,m as F,r as o,j as e,T as _t,e as St,s as c,S as At,f as It,L as Ge,D as Tt,g as Lt,P as Ye,R as $t,C as Pt,A as Et,H as Je,B as Rt,h as Ke,i as zt,k as Dt,F as Ot,W as Bt,l as Ft,n as Mt,o as Vt,p as Ut,N as fe,q as Ht,t as Z,v as qt,E as Wt,w as je,x as Xe,y as _e,z as Gt,G as re,I as Yt,J as Ze,K as Jt,M as U,O as Se,Q as Ae,U as Kt,V as Q,X as Qe,Y as Xt,Z as le,_ as de,$ as et,a0 as tt,a1 as at,a2 as Ie,a3 as Zt,a4 as Qt,a5 as ea,a6 as ta,a7 as st,a8 as aa,a9 as sa,aa as nt,ab as na,ac as ra,ad as ia,ae as rt,af as oa,ag as it,ah as la,ai as ot,aj as ce,ak as da,al as ve,am as Y,an as J,ao as ca,ap as ua,aq as xa,ar as ma,as as ha,at as Te,au as Le,av as pa,aw as ga,ax as ya,ay as fa,az as ja,aA as va,aB as wa,aC as ba,aD as ka,aE as $e,aF as Ca,aG as Na,aH as _a,aI as Sa,aJ as Aa,aK as Ia,aL as Ta,aM as La,aN as $a,aO as Pa,aP as Ea}from"./vendor-4beb22e1.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function s(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(r){if(r.ep)return;r.ep=!0;const i=s(r);fetch(r.href,i)}})();const Ra="modulepreload",za=function(t){return"/"+t},Pe={},v=function(a,s,n){if(!s||s.length===0)return a();const r=document.getElementsByTagName("link");return Promise.all(s.map(i=>{if(i=za(i),i in Pe)return;Pe[i]=!0;const l=i.endsWith(".css"),x=l?'[rel="stylesheet"]':"";if(!!n)for(let y=r.length-1;y>=0;y--){const j=r[y];if(j.href===i&&(!l||j.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${x}`))return;const h=document.createElement("link");if(h.rel=l?"stylesheet":Ra,l||(h.as="script",h.crossOrigin=""),h.href=i,document.head.appendChild(h),l)return new Promise((y,j)=>{h.addEventListener("load",y),h.addEventListener("error",()=>j(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>a()).catch(i=>{const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i})},A=()=>{const t=localStorage.getItem("token");if(t)return JSON.parse(t||"")},M=()=>Ct(),T=Nt,d=We.create({baseURL:"https://node-7-sarq.onrender.com/api"}),Da=We.create({baseURL:{}.VITE_DATABASE_RENDER}),V=A(),Oa=async t=>await d.post("/signup",t),Ba=async t=>await d.post("/signin",t),lt=async()=>await d.get("user"),Fa=async t=>await d.get("user_one/"+t),Ma=async t=>await d.delete("removeUser/"+t+`/${V.user._id}`,{headers:{Authorization:`Bearer ${V.token}`}}),Va=async t=>await d.put(`user/${t._id}/${V.user._id}`,t,{headers:{Authorization:`Bearer ${V.token}`}}),Ua=async t=>await d.post("user/creating",t),Ha=async t=>await d.get(`user/cart/${t}`),qa=async(t,a)=>await d.post(`/user/upload/${t}`,a,{headers:{Authorization:`Bearer ${V.token}`}}),Wa=async t=>await d.post("/forgot-password",t),Ga=async(t,a,s)=>await d.post(`/reset-password/${t}/${a}`,s),Ya=async t=>await d.post("/refreshToken",t),ee=A(),Ja=async()=>await d.get("/cart"),Ka=async t=>await d.post(`/cart/${ee.user._id}`,t,{headers:{Authorization:`Bearer ${ee.token}`}}),Xa=async(t,a)=>await d.post(`/cart/${t}/${ee.user._id}`,a,{headers:{Authorization:`Bearer ${ee.token}`}}),Ee=p("cartSlice",async()=>{const{data:t}=await Ja();return t}),ue=p("addCartSlice",async t=>{const{data:a}=await Ka(t);return a}),Za=p("deleteCartSlice",async t=>{const{data:a,status:s}=await Xa(t.id,t);return a.data}),Re=p("user/login",async t=>{const{data:a}=await Oa(t);return a}),oe=p("user/signin",async t=>{const{data:a,status:s}=await Ba(t);return a}),Qa=p("user/getAll",async()=>{const{data:t}=await lt();return t.filter(s=>s.role==0)}),xe=p("user/getUser_id",async t=>{const{data:a}=await Fa(t);return a}),es=p("admin/getAdmin",async()=>{const{data:t}=await lt();return t.filter(s=>s.role>=1)}),ze=p("user/deteleUser",async t=>{const{data:a}=await Ma(t);return a}),ts=p("edit/editUser",async t=>{const{data:a}=await Va(t);return a}),as=p("user/importXlsx",async t=>{const{data:a}=await Ua(t);return a}),De=p("findcart",async t=>{const{data:a}=await Ha(t);return a.cart}),Oe=p("uploadImage",async({id:t,formData:a})=>{const{data:s,status:n}=await qa(t,a);return s}),dt=B({name:"user",initialState:{value:[],cartUser:[],isLoading:!1,error:!1,login:{},isLogin:localStorage.getItem("isLogin")==="true",user:{}},reducers:{logout(t){localStorage.removeItem("token"),F.success("Logout successful!"),t.isLogin=!1,localStorage.setItem("isLogin","false"),t.user={}}},extraReducers:t=>{t.addCase(Re.fulfilled,(a,s)=>{a.error=!1,a.value=s.payload.newUser}).addCase(Re.rejected,(a,s)=>{a.error=!0}),t.addCase(oe.pending,(a,s)=>{a.isLoading=!0}).addCase(oe.fulfilled,(a,s)=>{localStorage.setItem("token",JSON.stringify(s.payload)),a.login=s.payload,a.error=!1,a.isLogin=!0,a.isLoading=!1,a.user=s.payload.user,localStorage.setItem("isLogin","true")}).addCase(oe.rejected,(a,s)=>{a.error=s.payload,a.isLoading=!1}),t.addCase(Qa.fulfilled,(a,s)=>{a.value=s.payload}),t.addCase(ze.fulfilled,(a,s)=>{a.value=a.value.filter(n=>n._id!==s.payload._id)}).addCase(ze.rejected,(a,s)=>{}),t.addCase(es.fulfilled,(a,s)=>{a.value=s.payload}),t.addCase(ts.fulfilled,(a,s)=>{a.value.push(s.payload)}),t.addCase(as.fulfilled,(a,s)=>{a.value.unshift(s.payload)}),t.addCase(De.pending,(a,s)=>{a.isLoading=!0}).addCase(De.fulfilled,(a,s)=>{a.isLoading=!1,a.cartUser=s.payload}),t.addCase(xe.fulfilled,(a,s)=>{a.user=s.payload,a.isLoading=!1}).addCase(xe.pending,(a,s)=>{a.isLoading=!0}),t.addCase(Oe.fulfilled,(a,s)=>{a.isLoading=!1,a.user=s.payload.data}).addCase(Oe.pending,(a,s)=>{a.isLoading=!0}),t.addCase(Za.fulfilled,(a,s)=>{const n=a.user.cart.filter(r=>r.product._id!==s.payload.product);a.user.cart=n})}}),{logout:ss}=dt.actions,ns=dt.reducer,K=A(),P=o.createContext(null),rs=t=>{const a=M(),{user:s}=T(j=>j.user),n=localStorage.getItem("isLogin"),r=T(j=>j.user.isLogin),[i,l]=o.useState(!1),[x,u]=o.useState(!1),h=()=>{u(!x)};o.useEffect(()=>{K&&a(xe(K.user._id))},[r,a,i]);const y={Auth:K||"",user:s,isLoggedIn:n,isLoggedInState:r,setReset:l,handleClick:h,state:x};return e.jsx(P.Provider,{value:y,children:t.children})},k=o.memo(({level:t,children:a,...s})=>e.jsx(_t,{...s,children:a})),te=({color:t,children:a,...s})=>e.jsx(St,{color:t,...s,children:a}),is=c.div`
height: 100vh;
`,ct=c.div`
position: relative;
height: 100vh;
