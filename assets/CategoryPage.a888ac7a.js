import{s as t,m as y,e as v,r as f,n as D,b as r,j as e,c as g,u as x,a as b,d as C,L as A,k as S,p as _}from"./index.731c63ef.js";import{a as T}from"./index.f9a8c38d.js";const $=n=>n.category.isLoading,l=t.div``,w=t.div`
@media (mix-width:768px){
  width:250px;
}
`;t.span``;const m=t.p``,L=t.div`
  font-size:18px;
  color:#fff;
  margin:0 20px;
`,k=({id:n})=>{const d=y(T),h=v();return y($),f.exports.useEffect(()=>{h(D(n)),window.scrollTo({top:0,behavior:"smooth"})},[n]),r(l,{children:[e(L,{className:"underline text-3xl font-extrabold dark:text-white",children:"Li\xEAn quan"}),e(l,{className:"categoryMovie px-3 mt-5",children:d?d.map((s,c)=>e(l,{className:"movie_css",children:e(l,{children:r(w,{className:"cateConten cateItem",style:{width:"100%"},children:[e(g,{to:"/q/"+s._id+`?n=${s.name}`,children:e("img",{style:{width:"100%"},src:s.linkImg,alt:""})}),e(l,{className:"cateTitle text-light mt-1",children:e(g,{to:"/q/"+s._id+`?n=${s.name}`,children:e(m,{children:s.name})})}),e(l,{className:"release_date",children:r(m,{children:["T\u1ED5ng ",s.sumSeri," t\u1EADp"]})}),e(l,{className:"release_date",children:e(m,{children:"Th\u1EDDi gian 20/12 ph\xFAt"})})]})})},c)):"Tr\u1ED1ng!"})]})},u=t.div``,N=t.span``,E=t.button`
padding: 9px 20px;
background: #000;
font-size: 15px;
border-radius: 3px;
