...
`,mn=l.exports.memo(({seriProduct:t})=>e(_,{gutter:14,items:"center",children:t.map((a,r)=>a.isApproved==!0?e(y,{xl:3,lg:3,md:4,sm:4,xs:6,className:"mt-2",children:e(Ee,{className:({isActive:s,isPending:n})=>s?"activeSeri":"",to:"/d/"+a._id+`?c=${a.category}`,children:e(pn,{className:a.seri&&"w-full",children:a.seri&&"T\u1EADp "+a.seri})})},r):"")})),$=l.exports.memo(({children:t,...a})=>e(Jt,{...a,children:t})),K=t=>U.success(t),Ct=t=>U.warning(t),F=t=>U.error(t),hn=({item:t,id:a})=>{var f;const r=H(),{Auth:s,user:n,isLoggedInState:o}=l.exports.useContext(R),[d,m]=l.exports.useState(!1),u={user:s?s.user._id:"",product:a};l.exports.useEffect(()=>{var w,N;const v=(w=n==null?void 0:n.cart)==null?void 0:w.find(A=>A.product._id===a);m(((N=v==null?void 0:v.product)==null?void 0:N._id)===a)},[n.cart,a]);const h=()=>{!s&&o==!1?F("B\u1EA1n c\u1EA7n \u0111\u0103ng nh\u1EADp!"):d?Ct("\u0110\xE3 t\u1ED3n t\u1EA1i trong y\xEAu th\xEDch!"):(r(xe(u)),m(!0),K("Th\xEAm v\xE0o danh s\xE1ch y\xEAu th\xEDch th\xE0nh c\xF4ng!"))};return i("div",{className:"lg:flex md:flex-row items-center @screen md:justify-between flex flex-col",children:[e(k,{to:"/q/"+((f=t==null?void 0:t.category)==null?void 0:f._id),className:"text-2xl md:text-3xl pl-2 my-2 border-l-4  font-sans font-bold border-teal-400  dark:text-gray-200",children:e(O,{level:4,style:{color:"#fff"},className:"uppercase",children:t.name})}),e($,{style:{color:"#fff"},icon:e(re,{}),disabled:d,className:"flex items-center justify-center",onClick:()=>h(),children:d?"\u0110\xE3 y\xEAu th\xEDch":"Th\xEAm v\xE0o y\xEAu th\xEDch"})]})},gn=({getOneProductDetail:t})=>i(T,{children:[e("div",{style:{color:"#fff",margin:"10px 0"},children:t.seri?t.trailer?"Trailer "+t.seri:"T\u1EADp "+t.seri:""}),e("div",{className:"des text-[#999]",children:i("p",{children:["Ng\xE0y \u0111\u0103ng:"," ",Kt(t.uploadDate).format("LTS DD-MM-YYYY")]})}),e("div",{style:{color:"#fff",margin:"10px 0"},className:"des",children:i("div",{className:"text-[#999] flex items-center gap-2 lg:justify-start @screen justify-center",children:[e(Xt,{}),t.view*36," L\u01B0\u1EE3t xem"]})}),i("div",{className:"p-3 mt-3 mb-3 text-white rounded  flex items-center lg:justify-start @screen justify-center",style:{background:"rgb(0 0 0 / 47%)"},children:["Copyright video:",e("div",{className:"text-slate-400",children:" "+t.copyright})]})]}),xn=p.div`
display:flex;
gap:0 10px;
...
`,kn=t=>t.product.isLoading,En=()=>{var N,A,B,X;const t=D(cn),a=D(dn),r=D(kn),[s,n]=l.exports.useState(""),{id:o}=ce(),{c:d}=Qt.parse(window.location.href.split("?")[1]),[m,u]=l.exports.useState("dailyMotion"),h=H(),[f,v]=l.exports.useState(""),w=Ce();return l.exports.useEffect(()=>{window.scrollTo(0,0)},[w]),l.exports.useEffect(()=>{h(we(o)),h(Et(d));const Q=$e.AES.decrypt(a.dailyMotionServer?a.dailyMotionServer:"","24062003").toString($e.enc.Utf8);v(Q),n(Q)},[o,a.dailyMotionServer]),i(T,{children:[e(_e,{ogTitle:a.name,description:a.category?.des,imageUrl:(N=a.category)==null?void 0:N.linkImg}),e("div",{className:"flex justify-center mt-4",style:{gap:"10px"},children:e(vn,{className:"col-md-12",children:a&&(r?e(Ae,{size:"large",children:void 0}):i(T,{children:[e(wn,{className:"d-flex justify-content-center relative",children:a.dailyMotionServer!==""&&a.server2!==""?e("iframe",{allowFullScreen:!0,title:"vimeo-player",className:"absolute",src:s,style:{width:"100%",height:"100%"}}):a.trailer!==""?e("iframe",{title:"vimeo-player",className:"absolute",style:{width:"100%",height:"100%"},src:a.trailer+"?autoplay=1&mute=1"}):e(Zt,{icon:"Hiiiii!!",className:"absolute inset-0 text-white mt-5",subTitle:"Phim n\xE0y \u0111ang trong qu\xE1 tr\xECnh c\u1EADp nh\u1EADt video. Vui l\xF2ng quay l\u1EA1i sau."})}),i(bn,{className:"mt-4 rounded",children:[e(oe,{textColor:"#fff",orientation:"center",className:"text-white md:text-sm lg:text-base text-sm underline",children:"Ch\u1ECDn server:"}),i("div",{className:"md:text-sm lg:text-base text-sm flex items-center justify-center gap-4 px-4 py-3",children:[e($,{disabled:a.link==="",onClick:()=>{u("link1"),n(a.link)},className:`text-white cursor-pointer ${m==="link1"?"activeServer":""}`,children:"#S1"}),e($,{onClick:()=>{u("server2"),n(a.server2)},disabled:!a.server2,className:`${a.server2?" text-white cursor-pointer":""} ${m==="server2"?"activeServer":""}`,children:"#S2"}),e($,{onClick:()=>{u("dailyMotion"),n(f)},disabled:!a.dailyMotionServer,className:`${a.dailyMotionServer?"text-white cursor-pointer":""} ${m==="dailyMotion"?"activeServer":""}`,children:"#S3"})]})]}),i(xn,{className:"mt-2",children:[e(yn,{className:"w-3/12",children:e(q,{className:"md:block hidden",alt:"\u1EA2nh"+((A=a.category)==null?void 0:A.name),src:z(200,a&&(((B=a.category)==null?void 0:B.linkImg)||a.image))})}),i(fn,{className:"lg:w-9/12 md:w-full text-center lg:text-start",children:[e(hn,{item:a,id:o}),e(gn,{getOneProductDetail:a}),e(mn,{seriProduct:t}),i("div",{className:"text-[#999] lg:text-md sm:text-sm mt-2 mb-2",children:[e(oe,{textColor:"#fff",orientation:"left",children:"M\xF4 t\u1EA3:"}),a&&((X=a.category)==null?void 0:X.des)]})]})]})]}))})})]})},Cn=()=>i(G.Fragment,{children:[e(l.exports.Suspense,{fallback:e(mr,{}),children:e(En,{})}),e(Se,{children:e(kt,{})})]}),Nn=({id:t})=>{const{data:a,isLoading:r}=I(L+"/category/getAllCategoryNotRequest/"+t),s=Ce();return l.exports.useEffect(()=>{window.scrollTo(0,0)},[s]),r?e(Ae,{size:void 0,children:void 0}):i(G.Fragment,{children:[e(O,{level:3,strong:!0,underline:!0,style:{color:"#fff"},className:"underline my-2",children:"Li\xEAn quan"}),e(bt,{type:"category",gutter:[16,16],child:a})]})},An=({data:t,isLoading:a})=>{var r;return a?e("div",{className:"seriLoading",children:"Loading...."}):e("div",{className:"bg-[#9b9b9b1f] h-[174px] overflow-y-scroll p-3 rounded-sm seriCategory",children:e(_,{gutter:[16,16],children:((r=t==null?void 0:t.products)==null?void 0:r.length)>0&&(t==null?void 0:t.products)?t.products.map((s,n)=>s.isApproved==!0?e(y,{lg:3,md:4,sm:5,xs:6,style:{textAlign:"center"},children:e(k,{to:"/d/"+s._id+`?c=${s.category}`,children:!s.dailyMotionServer&&s.trailer?e(Je,{children:s.seri}):e(Je,{className:"w-full text-white",variant:"ghost",size:"sm",children:s.seri})})},n):""):e(ft,{})})})},Sn=l.exports.memo(({id:t,averageRating:a,totalRatings:r})=>i("span",{className:"text-white flex items-center gap-2",children:[e(ea,{className:"mt-2 mb-2",value:a,onChange:async n=>{const o={rating:n};try{await Br(t,o)}catch(d){console.error("L\u1ED7i khi l\u01B0u \u0111\xE1nh gi\xE1:",d)}}}),r>0?e("div",{className:"relative pt-1",children:e("div",{className:"flex items-center justify-between",children:e("div",{children:i("span",{className:"text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-pink-600 bg-pink-200",children:["Vip ",a.toFixed(2),"/",r*115," T\u1ED5ng s\u1ED1 l\u01B0\u1EE3t \u0111\xE1nh gi\xE1"]})})})}):""]})),_n=()=>{const{id:t}=ce(),a=H(),r=D(n=>n.category.details),s=D(n=>n.category.isLoading);return l.exports.useEffect(()=>{a(ve(t))},[t]),l.exports.useEffect(()=>{r!=null&&r.name&&(document.title=r.name)},[r]),i(T,{children:[e(_e,{ogTitle:r.name,description:r==null?void 0:r.des,imageUrl:r==null?void 0:r.linkImg}),r&&e("div",{children:i("div",{style:{color:"#fff"},children:[i("div",{className:"md:flex lg:flex block gap-2 ",children:[e("div",{className:"mb-5 lg:w-3/12 md:w-3/12 md:h-full h-52 ",children:e("div",{className:"h-full w-full flex justify-center ",children:e(q,{className:"object-contain w-full h-full flex-grow",src:z(300,r.linkImg),alt:r.name})})}),i("div",{className:"lg:w-9/12 md:w-9/12",children:[e("div",{className:"category text-2xl md:text-3xl pl-2 my-2 border-l-4  font-sans font-bold border-teal-400  dark:text-gray-200",children:e(k,{to:"/q/"+r._id,children:e(O,{type:"secondary",level:3,className:"md:text-[18px] lg:text-[20px] sm:text-[15px]",style:{textTransform:"capitalize",color:"#fff"},children:r.name})})}),i("div",{className:"loai des text-[12px] md:text-[13px] lg:text-[14px]",children:[e("b",{children:r.anotherName}),e("br",{}),e(E,{style:{color:"#999"},children:"T\xE1c gi\u1EA3 :..."}),e("br",{}),e(E,{style:{color:"#999"},children:"Qu\u1ED1c gia : Chinese"}),e("div",{children:i(E,{style:{color:"#999"},children:["Th\u1EC3 lo\u1EA1i :"," ",e("span",{className:"p-1 bg-gray-500 rounded-sm",children:r.type})]})}),e("div",{children:i(E,{style:{color:"#999"},children:["T\u1ED5ng S\u1ED1 t\u1EADp: ",r._id==t?r.sumSeri:""]})}),e("div",{children:e(E,{style:{color:"#999"},children:r.time+" "})}),e("div",{children:i(E,{style:{color:"#999"},children:["N\u0103m ph\xE1t h\xE0nh : ",r.year]})}),e("div",{}),e(ie,{color:"#2db7f5",className:"my-2",children:r.isActive==0?"\u0110ang chi\u1EBFu":"Ho\xE0n th\xE0nh"}),i("div",{id:"toast-simple",className:"flex mb-2 items-center w-full max-w-xs p-4 space-x-4 rtl:space-x-reverse text-gray-500 bg-white divide-x rtl:divide-x-reverse divide-gray-200 rounded-lg shadow dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800",role:"alert",children:[e(st,{}),e("div",{className:"ps-4 text-sm font-normal",children:"Vietsub l\xFAc 10h00 Th\u1EE9 4 h\xE0ng tu\u1EA7n"})]})]}),e(An,{isLoading:s,data:r}),e(Sn,{id:t,averageRating:r.averageRating,totalRatings:r.totalRatings})]})]}),i("div",{className:"text-[#999] lg:text-[15px] md:text[14px] text-[13px]",children:[e(oe,{textColor:"#fff",orientation:"left",children:"N\u1ED8I DUNG PHIM"}),r.des]})]})},r._id)]})},Tn=()=>{const{id:t}=ce();return i(T,{children:[e(_n,{}),e(Se,{children:e(Nn,{id:t})})]})};const Ke=l.exports.memo(({title:t,src:a,size:r,...s})=>e("div",{title:t,style:{cursor:"pointer"},children:e(ta,{size:r,color:"default",src:a,...s})})),be=({isLoggedInState:t,style:a})=>{var d,m,u,h,f;const r=P(),s=Y(),n=H(),o=()=>{r?s("/cart/user"):F("B\u1EA1n c\u1EA7n \u0111\u0103ng nh\u1EADp!")};return e(G.Fragment,{children:r&&t?e(Re,{theme:{token:{colorBgBase:"#323232",colorTextBase:"#fff"}},children:e(ze,{content:i(T,{children:[e(k,{to:"/profile",children:i(_,{style:{lineHeight:"0"},align:"middle",gutter:12,children:[e(y,{children:e(aa,{})}),e(y,{children:e(E,{level:6,className:"auth",children:"Your profile"})})]})}),i(_,{style:{lineHeight:"0"},align:"middle",gutter:[12,12],children:[e(y,{children:e(re,{})}),e(y,{children:e(E,{style:{cursor:"pointer"},onClick:o,className:"auth",children:"Saved"})})]}),r.user&&((d=r==null?void 0:r.user)==null?void 0:d.role)>=1&&e(k,{to:"/dashboard",children:i(_,{style:{lineHeight:"0"},align:"middle",gutter:[12,12],children:[e(y,{children:e(ne,{})}),e(y,{children:e(E,{className:"auth",children:"Admin"})})]})}),i(_,{style:{lineHeight:"0"},align:"middle",gutter:[12,12],children:[e(y,{children:e(it,{})}),e(y,{children:e(E,{style:{cursor:"pointer"},onClick:()=>xr(n,s),children:"Logout"})})]})]}),title:e(O,{style:{textTransform:"uppercase"},type:"secondary",level:5,children:(m=r==null?void 0:r.user)==null?void 0:m.username}),placement:"bottomLeft",trigger:"click",children:e(Ke,{className:"text-center",title:(u=r==null?void 0:r.user)==null?void 0:u.name,src:z(50,r.user&&((h=r==null?void 0:r.user)==null?void 0:h.image)),size:"sm"})})}):e(Re,{theme:{token:{colorBgBase:"#323232",colorTextBase:"#fff"}},children:e(ze,{content:e(k,{to:"/signin",children:i(_,{align:"middle",gutter:[12,12],children:[e(y,{children:e(ra,{})}),e(y,{children:e(E,{level:6,className:"auth",children:"Signin"})})]})}),title:e(O,{style:{textTransform:"uppercase"},type:"secondary",level:5,children:"Hi"}),placement:"bottomLeft",trigger:"click",children:e(Ke,{title:(f=r==null?void 0:r.user)==null?void 0:f.name,src:void 0,style:a,size:40,icon:e(ne,{})})})})})},{Content:In,Sider:Ln,Header:Dn,Footer:Pn}=me,$n=()=>{var n;const t=ai.map((o,d)=>{var u;const m=String(d+1);return{key:`${m+1}`,icon:o.icon,label:e(k,{to:o.path,children:o.name}),children:(u=o==null?void 0:o.children)==null?void 0:u.map((h,f)=>{const v=f+1;return{key:`subitem-${m}-${v}`,icon:h.icon,label:e(k,{to:h.path,children:h.name})}})}}),{isLoggedInState:a}=(n=l.exports.useContext(R))!=null?n:{},[r,s]=l.exports.useState(!1);return i(me,{style:{minHeight:"100vh"},children:[i(Ln,{trigger:null,collapsible:!0,collapsed:r,className:"overflow-y-auto ",style:{height:"100%",position:"fixed"},children:[e("div",{className:"p-4 bg-[#fff]",children:e("div",{className:"h-8 w-full bg-[#ddd] rounded"})}),e(he,{style:{height:"100%"},theme:"light",mode:"inline",defaultSelectedKeys:["1"],items:t})]}),i(me,{style:{marginLeft:r?80:200},children:[e(Dn,{style:{backgroundColor:"rgba(0, 0, 0, 0.1)",padding:0},children:i(_,{align:"middle",justify:"space-between",children:[e(y,{children:e($,{type:"text",icon:r?e(ot,{}):e(lt,{}),onClick:()=>s(!r),style:{fontSize:"16px",width:64,height:64},children:void 0})}),e(y,{children:e(k,{to:"/",children:"Home Page"})}),e(y,{style:{textAlign:"center"},span:1,children:e(be,{isLoggedInState:a,style:void 0})})]})}),e(In,{style:{padding:"24px",minHeight:"calc(100vh - 64px)",overflow:"auto"},children:e(dt,{})}),e(Pn,{children:"\xA9 2023 copyright | PH ANG"})]})]})},Rn=t=>{const a=P();try{return a?a.user.role==0?e(Be,{to:"/"}):t.children:e(Be,{to:"/"})}catch{return e("div",{className:"text-light container text-center",children:e(k,{to:"/signin",children:"\u0110\u0103ng nh\u1EADp"})})}},zn=p.div`
color:#999;
font-weight:500;
`,Bn=p.div`
...
`;const Fn=l.exports.memo(({data:t,icons:a,id:r,background:s,...n})=>e(he,{className:"h-full",style:{background:s},children:t&&t.map((o,d)=>l.exports.createElement(he.Item,{...n,icon:o.icon?o.icon:a[d],key:d},r==!0?e(Ee,{to:o.path=="/"?o.path:o.path+`/${o._id}`,children:o.name},d):e(k,{to:o.path,children:o.name})))})),jn=p.div`
  display: block;
  @media (max-width: 768px) {
...
`,Nt=l.exports.memo(({onSubmit:t,formTitle:a,formDescription:r,submitButtonText:s,formIntro:n,formHeader:o,checkedAccount:d,handleMessage:m,redirect:u,array:h,schemaPage:f})=>{const{register:v,handleSubmit:w,formState:{errors:N}}=pt({resolver:ha(f)});return e("div",{className:"h-screen relative z-0",children:i(ms,{className:"g-6 flex flex-wrap justify-center w-full items-center absolute top-1/2 left-1/2 translate-x-2/4 translate-y-2/4",style:{transform:"translate(-50%,-50%)"},children:[i("div",{className:"w-8/12 items-center text-white hidden lg:block md:hidden",children:[e(vs,{className:"text-[50px] ",children:o}),i("div",{className:"flex items-center",children:[e(ys,{className:"w-2/12",children:n}),e(fs,{className:"w-10/12"})]})]}),i("div",{className:"md:w-8/12 lg:w-4/12 w-full lg:p-5 md:p-4 p-3",style:{background:"rgba(248, 248, 248, 0.04)",borderRadius:" 5px"},children:[i("div",{children:[e(hs,{children:a}),e(gs,{children:r})]}),i(ps,{onSubmit:w(t),children:[h&&h.map((A,B)=>e("div",{className:"relative lg:mb-6 md:mb-4 mb-2","data-te-input-wrapper-init":!0,children:i("div",{children:[e(us,{disabled:A.disable,style:{background:`${A.disable?"#99979742":""}`},type:A.type,...v(`${A.field}`),placeholder:A.field,className:"placeholder:capitalize"}),N&&N[A.field]&&e("div",{className:"text-sm text-pink-600 mt-1",children:N[A.field].message})]})},B)),e("div",{className:"lg:mb-6 md:mb-5 mb-4",children:e(tt,{to:"/forgot-password",children:i("div",{className:"text-center text-white text-sm font-medium text-primary-600 hover:underline text-primary-500",children:["Forgot password?"," "]})})}),e(cs,{type:"submit",className:"w-full text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600",children:s}),e("div",{className:"my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-300 after:mt-0.5 after:flex-1 after:border-t after:border-neutral-300",children:i("p",{className:"mx-4 mb-0 text-center text-white text-[12px]",children:[" ","OR"]})}),e(xs,{className:"flex justify-center",onClick:m,children:e(q,{style:{width:"30px",height:"30px"},src:"https://www.svgrepo.com/show/475656/google-color.svg",alt:""})}),e("div",{className:"lg:mb-6 md:mb-4 mb-2 text-center lg:mt-5 md:mt-3 mt-2 text-slate-400 ",children:e(k,{to:u,className:"text-sm text-primary-600 hover:underline text-primary-500",children:d})})]})]})]})})}),ws=[{type:"email",field:"email",disable:!1}],bs=()=>{const t=Y(),a=mt().shape({email:ge().required().email()});return e(Nt,{onSubmit:async n=>{const o=await Qa(n);o.data.success?(K(o.data.message),t("/signin")):F(o.data.message)},formTitle:"Forgot Password",formDescription:"Just some details to get you in.!",submitButtonText:"Send",formIntro:"Skip the lag ?",formHeader:"Roll the Carpet.!",checkedAccount:"Already Registered? Login",handleMessage:()=>{U.success("\u0110ang c\u1EADp nh\u1EADt!")},redirect:"/forgot-password",array:ws,schemaPage:a})},ks=[{type:"password",field:"password",disable:!1},{type:"password",field:"repassword",disable:!1}],Es=()=>{const t=Y(),{id:a,token:r}=ce(),s=mt().shape({password:ge().required().min(6,"Password t\u1ED1i thi\u1EC3u 6 k\xED t\u1EF1"),repassword:ge().required().oneOf([ga("password"),null],"Passwords must match")});return e(Nt,{onSubmit:async d=>{const m=await Za(a,r,d);m.data.success?(K(m.data.message),t("/signin")):F(m.data.message)},formTitle:"Reset Password",formDescription:"Just some details to get you in.!",submitButtonText:"Send",formIntro:"Skip the lag ?",formHeader:"Roll the Carpet.!",checkedAccount:"Already Registered? Login",handleMessage:()=>{U.success("\u0110ang c\u1EADp nh\u1EADt!")},redirect:"/reset-password",array:ks,schemaPage:s})},Cs=()=>{const t=["#eb2f96","#52c41a","#eba12f"],{data:{data:a}}=I(L+"/category/latest"),r=[{title:"Name",dataIndex:"name",key:"name",render:o=>e("p",{children:o})},{title:"Action",key:"action",render:(o,d,m)=>e($,{type:"text",shape:"circle",className:"ml-2",onClick:()=>s(d.key),children:e(Ne,{type:"success",style:{color:t[m]}})})}],s=async o=>{const d={id:o},{data:m}=await Or(d);m.success===!0&&(K("Success"),xa(L+"/category/latest"))},n=a&&a.map((o,d)=>({key:o._id,name:o.name}));return e(ut,{columns:r,dataSource:n})},Ns=()=>{const t=D(un),{data:a}=I(L+"/most-watched-episodes"),{data:r}=I(L+"/rating/stats"),s={data:a.data,xField:"seri",yField:"view",point:{shapeField:"square",sizeField:4},interaction:{tooltip:{marker:!1}},style:{lineWidth:2}};return i(T,{children:[i("div",{className:"flex justify-around gap-2",children:[e(Z,{className:"w-full",children:e(ee,{title:"Active Users",prefix:e(ne,{}),value:t.length})}),e(Z,{bordered:!0,className:"w-full",children:e(ee,{title:"Comment",value:11.28,precision:2,valueStyle:{color:"#3f8600"},prefix:e(Ne,{}),suffix:"%"})}),e(Z,{bordered:!1,className:"w-full",children:e(ee,{title:"View",value:9.3,precision:2,valueStyle:{color:"#cf1322"},prefix:e(ya,{}),suffix:"%"})}),e(Z,{className:"w-full",children:e(ee,{title:"Rating Video",prefix:e(fa,{}),value:r.totalRatings})})]}),e("div",{className:"flex justify-between gap-2",children:e(va,{className:"w-5/12",...s})})]})},As=l.exports.lazy(()=>b(()=>import("./index.7f335f33.js"),["assets/index.7f335f33.js","assets/index.0dda133d.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Ss=l.exports.lazy(()=>b(()=>import("./index.3f39ee89.js"),["assets/index.3f39ee89.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css","assets/index.0dda133d.js","assets/index.1fa14f85.js"])),_s=l.exports.lazy(()=>b(()=>Promise.resolve().then(()=>Xn),void 0)),Ts=l.exports.lazy(()=>b(()=>import("./Profile.fdf9c86c.js"),["assets/Profile.fdf9c86c.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Is=l.exports.lazy(()=>b(()=>import("./Sign-in.e4e0abc3.js"),["assets/Sign-in.e4e0abc3.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Ls=l.exports.lazy(()=>b(()=>import("./Sign-up.2f498798.js"),["assets/Sign-up.2f498798.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Ds=l.exports.lazy(()=>b(()=>import("./list.29fa907f.js"),["assets/list.29fa907f.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Ps=l.exports.lazy(()=>b(()=>import("./index.2b7a8ae4.js"),["assets/index.2b7a8ae4.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),$s=l.exports.lazy(()=>b(()=>import("./add.e664bc26.js"),["assets/add.e664bc26.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Rs=l.exports.lazy(()=>b(()=>import("./edit.63d90d39.js"),["assets/edit.63d90d39.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),zs=l.exports.lazy(()=>b(()=>import("./admin.23ef8c94.js"),["assets/admin.23ef8c94.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Bs=l.exports.lazy(()=>b(()=>import("./add.7eb0454a.js"),["assets/add.7eb0454a.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css","assets/index.a7d1d11e.js","assets/index.f123304c.js"])),Os=l.exports.lazy(()=>b(()=>import("./edit.7ec790f0.js"),["assets/edit.7ec790f0.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css","assets/index.a7d1d11e.js","assets/index.f123304c.js"])),Fs=l.exports.lazy(()=>b(()=>import("./adds.506b3c07.js"),["assets/adds.506b3c07.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),js=l.exports.lazy(()=>b(()=>import("./CreatingProducts.49535a1d.js"),["assets/CreatingProducts.49535a1d.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css","assets/index.f123304c.js"])),Vs=l.exports.lazy(()=>b(()=>import("./index.ad9ec571.js"),["assets/index.ad9ec571.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css","assets/type.96ab7541.js","assets/index.a7d1d11e.js","assets/index.f123304c.js"])),Ms=l.exports.lazy(()=>b(()=>import("./edit.9cf0f585.js"),["assets/edit.9cf0f585.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css","assets/index.f123304c.js","assets/index.a7d1d11e.js"])),Us=l.exports.lazy(()=>b(()=>import("./index.3b40d371.js"),["assets/index.3b40d371.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Hs=l.exports.lazy(()=>b(()=>import("./edit.a06ae55f.js"),["assets/edit.a06ae55f.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),qs=l.exports.lazy(()=>b(()=>import("./index.c3e68544.js"),["assets/index.c3e68544.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Ws=l.exports.lazy(()=>b(()=>import("./index.9f1dc861.js"),["assets/index.9f1dc861.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Gs=l.exports.lazy(()=>b(()=>import("./index.07583e16.js"),["assets/index.07583e16.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Ys=l.exports.lazy(()=>b(()=>import("./index.1a3defe4.js"),["assets/index.1a3defe4.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css","assets/index.1fa14f85.js","assets/index.0dda133d.js"])),Js=l.exports.lazy(()=>b(()=>import("./index.273832c7.js"),["assets/index.273832c7.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css","assets/type.96ab7541.js"])),Ks=l.exports.lazy(()=>b(()=>import("./CatemainProduct.e869b311.js"),["assets/CatemainProduct.e869b311.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Xs=l.exports.lazy(()=>b(()=>import("./index.0fe8f19d.js"),["assets/index.0fe8f19d.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Qs=l.exports.lazy(()=>b(()=>import("./edit.9f24439f.js"),["assets/edit.9f24439f.js","assets/vendor.bb3b024f.js","assets/vendor.3a42adf8.css"])),Zs=[{path:"/",name:"Trang ch\u1EE7",title:"Trang ch\u1EE7"},{path:"/signin",name:"\u0110\u0103ng nh\u1EADp",title:"\u0110\u0103ng nh\u1EADp"},{path:"/signup",name:"\u0110\u0103ng k\xED",title:"\u0110\u0103ng k\xED"},{path:"/complete",name:"Ho\xE0n Th\xE0nh",title:"Ho\xE0n Th\xE0nh"}],ei=[{path:"/",name:"Trang ch\u1EE7"},{path:"/profile",name:"H\u1ED3 s\u01A1",title:"H\u1ED3 s\u01A1"},{path:"/complete",name:"Ho\xE0n Th\xE0nh",title:"Ho\xE0n Th\xE0nh"}],ti=[{path:"/",element:e(ss,{}),children:[{path:"/",element:e(Wr,{}),index:!0},{path:"d/:id",element:e(g,{children:e(Cn,{})})},{path:"q/:id",element:e(g,{children:e(Tn,{})})},{path:"search/category",element:e(g,{children:e(_s,{})})},{path:"cart/user",element:e(g,{children:e(Ws,{})})},{path:"movie-content/:id",element:e(g,{children:e(Ss,{})})},{path:"types/h/:id",element:e(g,{children:e(As,{})})},{path:"loadmore",element:e(g,{children:e(Ys,{})})},{path:"signup",element:e(g,{children:e(Ls,{})})},{path:"signin",element:e(g,{children:e(Is,{})})},{path:"forgot-password",element:e(g,{children:e(bs,{})})},{path:"reset-password/:id/:token",element:e(g,{children:e(Es,{})})},{path:"profile",element:e(g,{children:e(Ts,{})})}]},{path:"dashboard",element:e(Rn,{children:e($n,{})}),children:[{path:"",element:e(g,{children:e(Ns,{})}),index:!0},{path:"products",element:e(g,{children:e(Ds,{})})},{path:"users",element:e(g,{children:e(Ps,{})})},{path:"adminUer",element:e(g,{children:e(zs,{})})},{path:"users/:id/edit",element:e(g,{children:e(Rs,{})})},{path:"user/add",element:e(g,{children:e($s,{})})},{path:"user/creatingUser",element:e(g,{children:e(Fs,{})})},{path:"product/add",element:e(g,{children:e(Bs,{})})},{path:"product/edit/:id",element:e(g,{children:e(Os,{})})},{path:"product/creacting",element:e(g,{children:e(js,{})})},{path:"category",element:e(g,{children:e(Vs,{})})},{path:"category/edit/:id",element:e(g,{children:e(Ms,{})})},{path:"category/latest",element:e(g,{children:e(Cs,{})})},{path:"trailing",element:e(g,{children:e(Us,{})})},{path:"trailerUrl/:id",element:e(g,{children:e(Hs,{})})},{path:"comments",element:e(g,{children:e(qs,{})})},{path:"cart",element:e(g,{children:e(Gs,{})})},{path:"types",element:e(g,{children:e(Js,{})})},{path:"types/CateMainProduct/:id",element:e(g,{children:e(Ks,{})})},{path:"background",element:e(g,{children:e(Xs,{})})},{path:"background/edit/:id",element:e(g,{children:e(Qs,{})})},{path:"weeks",element:e(g,{children:e(ls,{})})}]},{path:"/*",element:e(ds,{})}],ai=[{path:"/dashboard",name:"Admin",icon:e(wa,{})},{path:"/dashboard/products",name:"Products",icon:e(ba,{})},{name:"User",icon:e(Oe,{}),children:[{path:"/dashboard/users",name:"Users",icon:e(ne,{})},{path:"/dashboard/adminUer",name:"Admin",icon:e(Fe,{})}]},{name:"Category",icon:e(Oe,{}),children:[{path:"/dashboard/category",name:"Category",icon:e(ka,{})},{path:"/dashboard/category/latest",name:"Latest",icon:e(Ne,{})}]},{name:"Themes",icon:e(ct,{}),children:[{path:"/dashboard/trailing",name:"Trailer",icon:e(Fe,{})},{path:"/dashboard/background",name:"Background",icon:e(Ea,{})}]},{name:"Big Category",icon:e(rt,{}),children:[{path:"/dashboard/types",name:"Types",icon:e(Ca,{})}]},{path:"/dashboard/comments",name:"Comments",icon:e(Na,{})},{path:"/dashboard/cart",name:"Cart",icon:e(Aa,{})},{path:"/dashboard/weeks",icon:e(st,{}),name:"Week"}],ri=Sa`
:root{
  textarea {
    outline: none;
  }
