import{u as St,a as _t,b as Ge,c as p,d as M,m as V,r as o,j as e,T as At,e as It,s as c,S as Tt,f as Lt,L as Ye,D as $t,g as Pt,P as Je,R as Et,C as Rt,A as zt,H as Ke,B as Dt,h as Xe,i as Ot,k as Bt,F as Ft,W as Mt,l as Vt,n as Ut,o as Ht,p as qt,N as fe,q as Wt,t as Q,v as Gt,E as Yt,w as re,x as Qe,y as _e,z as Jt,G as je,I as Kt,J as Ze,K as Xt,M as q,O as Ae,Q as Ie,U as Qt,V as Z,X as et,Y as Zt,Z as le,_ as de,$ as tt,a0 as at,a1 as st,a2 as Te,a3 as ea,a4 as ta,a5 as aa,a6 as sa,a7 as nt,a8 as na,a9 as ra,aa as rt,ab as ia,ac as oa,ad as la,ae as ve,af as da,ag as it,ah as ca,ai as ot,aj as ce,ak as ua,al as we,am as J,an as K,ao as xa,ap as ma,aq as ha,ar as lt,as as pa,at as ga,au as ya,av as Le,aw as $e,ax as fa,ay as ja,az as va,aA as wa,aB as ba,aC as ka,aD as Ca,aE as Na,aF as Sa,aG as Pe,aH as _a,aI as Aa,aJ as Ia,aK as Ta,aL as La,aM as $a,aN as Pa,aO as Ea,aP as Ra,aQ as za,aR as Da}from"./vendor-172e24aa.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function s(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(r){if(r.ep)return;r.ep=!0;const i=s(r);fetch(r.href,i)}})();const Oa="modulepreload",Ba=function(t){return"/"+t},Ee={},w=function(a,s,n){if(!s||s.length===0)return a();const r=document.getElementsByTagName("link");return Promise.all(s.map(i=>{if(i=Ba(i),i in Ee)return;Ee[i]=!0;const l=i.endsWith(".css"),x=l?'[rel="stylesheet"]':"";if(!!n)for(let g=r.length-1;g>=0;g--){const y=r[g];if(y.href===i&&(!l||y.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${x}`))return;const m=document.createElement("link");if(m.rel=l?"stylesheet":Oa,l||(m.as="script",m.crossOrigin=""),m.href=i,document.head.appendChild(m),l)return new Promise((g,y)=>{m.addEventListener("load",g),m.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>a()).catch(i=>{const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i})},L=()=>{const t=localStorage.getItem("token");if(t)return JSON.parse(t||"")},D=()=>St(),I=_t,d=Ge.create({baseURL:"https://node-10-bu6r.onrender.com/api"}),Fa=Ge.create({baseURL:{}.VITE_DATABASE_RENDER}),H=L(),Ma=async t=>await d.post("/signup",t),Va=async t=>await d.post("/signin",t),dt=async()=>await d.get("user"),Ua=async t=>await d.get("user_one/"+t),Ha=async t=>await d.delete("removeUser/"+t+`/${H.user._id}`,{headers:{Authorization:`Bearer ${H.token}`}}),qa=async t=>await d.put(`user/${t._id}/${H.user._id}`,t,{headers:{Authorization:`Bearer ${H.token}`}}),Wa=async t=>await d.post("user/creating",t),Ga=async t=>await d.get(`user/cart/${t}`),Ya=async(t,a)=>await d.post(`/user/upload/${t}`,a,{headers:{Authorization:`Bearer ${H.token}`}}),Ja=async t=>await d.post("/forgot-password",t),Ka=async(t,a,s)=>await d.post(`/reset-password/${t}/${a}`,s),Xa=async t=>await d.post("/refreshToken",t),ee=L(),Qa=async()=>await d.get("/cart"),Za=async t=>await d.post(`/cart/${ee.user._id}`,t,{headers:{Authorization:`Bearer ${ee.token}`}}),es=async(t,a)=>await d.post(`/cart/${t}/${ee.user._id}`,a,{headers:{Authorization:`Bearer ${ee.token}`}}),Re=p("cartSlice",async()=>{const{data:t}=await Qa();return t}),ue=p("addCartSlice",async t=>{const{data:a}=await Za(t);return a}),ts=p("deleteCartSlice",async t=>{const{data:a,status:s}=await es(t.id,t);return a.data}),ze=p("user/login",async t=>{const{data:a}=await Ma(t);return a}),oe=p("user/signin",async t=>{const{data:a,status:s}=await Va(t);return a}),as=p("user/getAll",async()=>{const{data:t}=await dt();return t.filter(s=>s.role==0)}),xe=p("user/getUser_id",async t=>{const{data:a}=await Ua(t);return a}),ss=p("admin/getAdmin",async()=>{const{data:t}=await dt();return t.filter(s=>s.role>=1)}),De=p("user/deteleUser",async t=>{const{data:a}=await Ha(t);return a}),ns=p("edit/editUser",async t=>{const{data:a}=await qa(t);return a}),rs=p("user/importXlsx",async t=>{const{data:a}=await Wa(t);return a}),Oe=p("findcart",async t=>{const{data:a}=await Ga(t);return a.cart}),Be=p("uploadImage",async({id:t,formData:a})=>{const{data:s,status:n}=await Ya(t,a);return s}),ct=M({name:"user",initialState:{value:[],cartUser:[],isLoading:!1,error:!1,login:{},isLogin:localStorage.getItem("isLogin")==="true",user:{}},reducers:{logout(t){localStorage.removeItem("token"),V.success("Logout successful!"),t.isLogin=!1,localStorage.setItem("isLogin","false"),t.user={}}},extraReducers:t=>{t.addCase(ze.fulfilled,(a,s)=>{a.error=!1,a.value=s.payload.newUser}).addCase(ze.rejected,(a,s)=>{a.error=!0}),t.addCase(oe.pending,(a,s)=>{a.isLoading=!0}).addCase(oe.fulfilled,(a,s)=>{localStorage.setItem("token",JSON.stringify(s.payload)),a.login=s.payload,a.error=!1,a.isLogin=!0,a.isLoading=!1,a.user=s.payload.user,localStorage.setItem("isLogin","true")}).addCase(oe.rejected,(a,s)=>{a.error=s.payload,a.isLoading=!1}),t.addCase(as.fulfilled,(a,s)=>{a.value=s.payload}),t.addCase(De.fulfilled,(a,s)=>{a.value=a.value.filter(n=>n._id!==s.payload._id)}).addCase(De.rejected,(a,s)=>{}),t.addCase(ss.fulfilled,(a,s)=>{a.value=s.payload}),t.addCase(ns.fulfilled,(a,s)=>{a.value.push(s.payload)}),t.addCase(rs.fulfilled,(a,s)=>{a.value.unshift(s.payload)}),t.addCase(Oe.pending,(a,s)=>{a.isLoading=!0}).addCase(Oe.fulfilled,(a,s)=>{a.isLoading=!1,a.cartUser=s.payload}),t.addCase(xe.fulfilled,(a,s)=>{a.user=s.payload,a.isLoading=!1}).addCase(xe.pending,(a,s)=>{a.isLoading=!0}),t.addCase(Be.fulfilled,(a,s)=>{a.isLoading=!1,a.user=s.payload.data}).addCase(Be.pending,(a,s)=>{a.isLoading=!0}),t.addCase(ts.fulfilled,(a,s)=>{const n=a.user.cart.filter(r=>r.product._id!==s.payload.product);a.user.cart=n})}}),{logout:is}=ct.actions,os=ct.reducer,X=L(),R=o.createContext(null),ls=t=>{const a=D(),{user:s}=I(y=>y.user),n=localStorage.getItem("isLogin"),r=I(y=>y.user.isLogin),[i,l]=o.useState(!1),[x,u]=o.useState(!1),m=()=>{u(!x)};o.useEffect(()=>{X&&a(xe(X.user._id))},[r,a,i]);const g={Auth:X||"",user:s,isLoggedIn:n,isLoggedInState:r,setReset:l,handleClick:m,state:x};return e.jsx(R.Provider,{value:g,children:t.children})},C=o.memo(({level:t,children:a,...s})=>e.jsx(At,{...s,children:a})),te=({color:t,children:a,...s})=>e.jsx(It,{color:t,...s,children:a}),ds=c.div`
height: 100vh;
`,ut=c.div`
position: relative;
height: 100vh;
...
`,vt=o.memo(({onSubmit:t,formTitle:a,formDescription:s,submitButtonText:n,formIntro:r,formHeader:i,checkedAccount:l,handleMessage:x,redirect:u,array:m,schemaPage:g})=>{const{register:y,handleSubmit:f,formState:{errors:N}}=ve({resolver:ca(g)});return e.jsx("div",{className:"h-screen relative z-0",children:e.jsxs(xr,{className:"g-6 flex flex-wrap justify-center w-full items-center absolute top-1/2 left-1/2 translate-x-2/4 translate-y-2/4",style:{transform:"translate(-50%,-50%)"},children:[e.jsxs("div",{className:"w-8/12 items-center text-white hidden lg:block md:hidden",children:[e.jsx(fr,{className:"text-[50px] ",children:i}),e.jsxs("div",{className:"flex items-center",children:[e.jsx(gr,{className:"w-2/12",children:r}),e.jsx(yr,{className:"w-10/12"})]})]}),e.jsxs("div",{className:"md:w-8/12 lg:w-4/12 w-full lg:p-5 md:p-4 p-3",style:{background:"rgba(248, 248, 248, 0.04)",borderRadius:" 5px"},children:[e.jsxs("div",{children:[e.jsx(mr,{children:a}),e.jsx(hr,{children:s})]}),e.jsxs(ur,{onSubmit:f(t),children:[m&&m.map((v,$)=>e.jsx("div",{className:"relative lg:mb-6 md:mb-4 mb-2","data-te-input-wrapper-init":!0,children:e.jsxs("div",{children:[e.jsx(cr,{disabled:v.disable,style:{background:`${v.disable?"#99979742":""}`},type:v.type,...y(`${v.field}`),placeholder:v.field,className:"placeholder:capitalize"}),N&&N[v.field]&&e.jsx("div",{className:"text-sm text-pink-600 mt-1",children:N[v.field].message})]})},$)),e.jsx("div",{className:"lg:mb-6 md:mb-5 mb-4",children:e.jsx(Ye,{to:"/forgot-password",children:e.jsxs("div",{className:"text-center text-white text-sm font-medium text-primary-600 hover:underline text-primary-500",children:["Forgot password?"," "]})})}),e.jsx(dr,{type:"submit",className:"w-full text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600",children:n}),e.jsx("div",{className:"my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-300 after:mt-0.5 after:flex-1 after:border-t after:border-neutral-300",children:e.jsxs("p",{className:"mx-4 mb-0 text-center text-white text-[12px]",children:[" ","OR"]})}),e.jsx(pr,{className:"flex justify-center",onClick:x,children:e.jsx(W,{style:{width:"30px",height:"30px"},src:"https://www.svgrepo.com/show/475656/google-color.svg",alt:""})}),e.jsx("div",{className:"lg:mb-6 md:mb-4 mb-2 text-center lg:mt-5 md:mt-3 mt-2 text-slate-400 ",children:e.jsx(b,{to:u,className:"text-sm text-primary-600 hover:underline text-primary-500",children:l})})]})]})]})})}),jr=[{type:"email",field:"email",disable:!1}],vr=()=>{const t=q(),a=ot().shape({email:ce().required().email()}),s=async r=>{const i=await Ja(r);i.data.success?(Y(i.data.message),t("/signin")):B(i.data.message)},n=()=>{V.success("Đang cập nhật!")};return e.jsx(vt,{onSubmit:s,formTitle:"Forgot Password",formDescription:"Just some details to get you in.!",submitButtonText:"Send",formIntro:"Skip the lag ?",formHeader:"Roll the Carpet.!",checkedAccount:"Already Registered? Login",handleMessage:n,redirect:"/forgot-password",array:jr,schemaPage:a})},wr=[{type:"password",field:"password",disable:!1},{type:"password",field:"repassword",disable:!1}],br=()=>{const t=q(),{id:a,token:s}=re(),n=ot().shape({password:ce().required().min(6,"Password tối thiểu 6 kí tự"),repassword:ce().required().oneOf([ua("password"),null],"Passwords must match")}),r=async l=>{const x=await Ka(a,s,l);x.data.success?(Y(x.data.message),t("/signin")):B(x.data.message)},i=()=>{V.success("Đang cập nhật!")};return e.jsx(vt,{onSubmit:r,formTitle:"Reset Password",formDescription:"Just some details to get you in.!",submitButtonText:"Send",formIntro:"Skip the lag ?",formHeader:"Roll the Carpet.!",checkedAccount:"Already Registered? Login",handleMessage:i,redirect:"/reset-password",array:wr,schemaPage:n})},kr=()=>{const t=["#eb2f96","#52c41a","#eba12f"],{data:{data:a}}=P(T+"/category/latest"),s=[{title:"Name",dataIndex:"name",key:"name",render:i=>e.jsx("p",{children:i})},{title:"Action",key:"action",render:(i,l,x)=>e.jsx(A,{type:"text",shape:"circle",className:"ml-2",onClick:()=>n(l.key),children:e.jsx(we,{type:"success",style:{color:t[x]}})})}],n=async i=>{const l={id:i},{data:x}=await Ps(l);x.success===!0&&(Y("Success"),it(T+"/category/latest"))},r=a&&a.map((i,l)=>({key:i._id,name:i.name}));return e.jsx(rt,{columns:s,dataSource:r})},Cr=()=>{const t=I(xn),{data:a}=P(T+"/most-watched-episodes"),{data:s}=P(T+"/rating/stats"),n={data:a.data,xField:"seri",yField:"view",point:{shapeField:"square",sizeField:4},interaction:{tooltip:{marker:!1}},style:{lineWidth:2}};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex justify-around gap-2",children:[e.jsx(J,{className:"w-full",children:e.jsx(K,{title:"Active Users",prefix:e.jsx(Z,{}),value:t.length})}),e.jsx(J,{bordered:!0,className:"w-full",children:e.jsx(K,{title:"Comment",value:11.28,precision:2,valueStyle:{color:"#3f8600"},prefix:e.jsx(we,{}),suffix:"%"})}),e.jsx(J,{bordered:!1,className:"w-full",children:e.jsx(K,{title:"View",value:9.3,precision:2,valueStyle:{color:"#cf1322"},prefix:e.jsx(xa,{}),suffix:"%"})}),e.jsx(J,{className:"w-full",children:e.jsx(K,{title:"Rating Video",prefix:e.jsx(ma,{}),value:s.totalRatings})})]}),e.jsx("div",{className:"flex justify-between gap-2",children:e.jsx(ha,{className:"w-5/12",...n})})]})},{SHOW_PARENT:Nr}=lt,Sr=()=>{const t=D(),{data:a}=I(v=>v.category.category),[s,n]=o.useState([]),{id:r}=re(),{data:i,isLoading:l}=P(T+"/week?w="+r),{handleSubmit:x,reset:u,control:m}=ve();o.useEffect(()=>{var v;i&&(u(i),n((v=i==null?void 0:i.content)==null?void 0:v.map($=>$._id))),t(U(0))},[i]);const g=v=>{console.log(v),n(v)},y=async v=>{const $=await ws(r,s);$!=null&&$.data&&pa.success(`Edit ${v.name} Success`)},N={treeData:a==null?void 0:a.map(v=>({title:v.name,value:v._id,key:v._id})),value:s,onChange:g,treeCheckable:!0,showCheckedStrategy:Nr,placeholder:"Please select",style:{width:"100%"}};return l?"Loading...":e.jsxs("div",{className:"p-6 bg-white rounded-lg shadow-md",children:[e.jsx(z,{level:4,className:"mb-4 text-lg font-semibold"}),e.jsxs("form",{onSubmit:x(y),className:"space-y-4",children:[e.jsx(jt,{name:"name",label:"Week name",control:m,className:"w-full"}),e.jsx(lt,{...N}),e.jsx(A,{htmlType:"submit",children:"Submit"})]})]})},_r=o.lazy(()=>w(()=>import("./index-5eedeb82.js"),["assets/index-5eedeb82.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),Ar=o.lazy(()=>w(()=>import("./index-743d936d.js"),["assets/index-743d936d.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css","assets/index-b303e36e.js"])),Ir=o.lazy(()=>w(()=>import("./index-14e57567.js"),["assets/index-14e57567.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css","assets/index-b303e36e.js","assets/index-8d17ba9d.js"])),Tr=o.lazy(()=>w(()=>Promise.resolve().then(()=>Kn),void 0)),Lr=o.lazy(()=>w(()=>import("./Profile-5c356e2a.js"),["assets/Profile-5c356e2a.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),$r=o.lazy(()=>w(()=>import("./Sign-in-6e62ce12.js"),["assets/Sign-in-6e62ce12.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),Pr=o.lazy(()=>w(()=>import("./Sign-up-c97628c8.js"),["assets/Sign-up-c97628c8.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),Er=o.lazy(()=>w(()=>import("./index-591a680b.js"),["assets/index-591a680b.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),Rr=o.lazy(()=>w(()=>import("./add-83739d5a.js"),["assets/add-83739d5a.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),zr=o.lazy(()=>w(()=>import("./edit-23c2e593.js"),["assets/edit-23c2e593.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),Dr=o.lazy(()=>w(()=>import("./admin-05efd404.js"),["assets/admin-05efd404.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),Or=o.lazy(()=>w(()=>import("./add-f6d6b6ec.js"),["assets/add-f6d6b6ec.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css","assets/index-e343f0e5.js","assets/index-52039a51.js"])),Br=o.lazy(()=>w(()=>import("./edit-92738a0e.js"),["assets/edit-92738a0e.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css","assets/index-e343f0e5.js","assets/index-52039a51.js"])),Fr=o.lazy(()=>w(()=>import("./adds-59190977.js"),["assets/adds-59190977.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),Mr=o.lazy(()=>w(()=>import("./CreatingProducts-c33fdaa4.js"),["assets/CreatingProducts-c33fdaa4.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css","assets/index-52039a51.js"])),Vr=o.lazy(()=>w(()=>import("./index-5450d396.js"),["assets/index-5450d396.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css","assets/type-6af3f430.js","assets/index-e343f0e5.js","assets/index-52039a51.js"])),Ur=o.lazy(()=>w(()=>import("./edit-cce045f2.js"),["assets/edit-cce045f2.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css","assets/index-52039a51.js","assets/index-e343f0e5.js"])),Hr=o.lazy(()=>w(()=>import("./index-94dacf9d.js"),["assets/index-94dacf9d.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),qr=o.lazy(()=>w(()=>import("./edit-20eec8f1.js"),["assets/edit-20eec8f1.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),Wr=o.lazy(()=>w(()=>import("./index-09eef593.js"),["assets/index-09eef593.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),Gr=o.lazy(()=>w(()=>import("./index-40a8433f.js"),["assets/index-40a8433f.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),Yr=o.lazy(()=>w(()=>import("./index-fb08ba13.js"),["assets/index-fb08ba13.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),Jr=o.lazy(()=>w(()=>import("./index-1c361b3a.js"),["assets/index-1c361b3a.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css","assets/index-8d17ba9d.js","assets/index-b303e36e.js"])),Kr=o.lazy(()=>w(()=>import("./index-abff9e8c.js"),["assets/index-abff9e8c.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css","assets/type-6af3f430.js"])),Xr=o.lazy(()=>w(()=>import("./CatemainProduct-d65acb27.js"),["assets/CatemainProduct-d65acb27.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),Qr=o.lazy(()=>w(()=>import("./index-0feaa122.js"),["assets/index-0feaa122.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),Zr=o.lazy(()=>w(()=>import("./edit-eff47860.js"),["assets/edit-eff47860.js","assets/vendor-172e24aa.js","assets/vendor-683f7613.css"])),ei=[{path:"/",name:"Trang chủ",title:"Trang chủ"},{path:"/signin",name:"Đăng nhập",title:"Đăng nhập"},{path:"/signup",name:"Đăng kí",title:"Đăng kí"}],ti=[{path:"/",name:"Trang chủ"},{path:"/profile",name:"Hồ sơ",title:"Hồ sơ"}],ai=[{path:"/",element:e.jsx(nr,{}),children:[{path:"/",element:e.jsx(qs,{}),index:!0},{path:"d/:id",element:e.jsx(h,{children:e.jsx(Cn,{})})},{path:"q/:id",element:e.jsx(h,{children:e.jsx(An,{})})},{path:"search/category",element:e.jsx(h,{children:e.jsx(Tr,{})})},{path:"cart/user",element:e.jsx(h,{children:e.jsx(Gr,{})})},{path:"movie-content/:id",element:e.jsx(h,{children:e.jsx(Ir,{})})},{path:"types/h/:id",element:e.jsx(h,{children:e.jsx(Ar,{})})},{path:"loadmore",element:e.jsx(h,{children:e.jsx(Jr,{})})},{path:"signup",element:e.jsx(h,{children:e.jsx(Pr,{})})},{path:"signin",element:e.jsx(h,{children:e.jsx($r,{})})},{path:"forgot-password",element:e.jsx(h,{children:e.jsx(vr,{})})},{path:"reset-password/:id/:token",element:e.jsx(h,{children:e.jsx(br,{})})},{path:"profile",element:e.jsx(h,{children:e.jsx(Lr,{})})}]},{path:"dashboard",element:e.jsx(En,{children:e.jsx(Pn,{})}),children:[{path:"",element:e.jsx(h,{children:e.jsx(Cr,{})}),index:!0},{path:"products",element:e.jsx(h,{children:e.jsx(_r,{})})},{path:"users",element:e.jsx(h,{children:e.jsx(Er,{})})},{path:"adminUer",element:e.jsx(h,{children:e.jsx(Dr,{})})},{path:"users/:id/edit",element:e.jsx(h,{children:e.jsx(zr,{})})},{path:"user/add",element:e.jsx(h,{children:e.jsx(Rr,{})})},{path:"user/creatingUser",element:e.jsx(h,{children:e.jsx(Fr,{})})},{path:"product/add",element:e.jsx(h,{children:e.jsx(Or,{})})},{path:"product/edit/:id",element:e.jsx(h,{children:e.jsx(Br,{})})},{path:"product/creacting",element:e.jsx(h,{children:e.jsx(Mr,{})})},{path:"category",element:e.jsx(h,{children:e.jsx(Vr,{})})},{path:"category/edit/:id",element:e.jsx(h,{children:e.jsx(Ur,{})})},{path:"category/latest",element:e.jsx(h,{children:e.jsx(kr,{})})},{path:"trailing",element:e.jsx(h,{children:e.jsx(Hr,{})})},{path:"trailerUrl/:id",element:e.jsx(h,{children:e.jsx(qr,{})})},{path:"comments",element:e.jsx(h,{children:e.jsx(Wr,{})})},{path:"cart",element:e.jsx(h,{children:e.jsx(Yr,{})})},{path:"types",element:e.jsx(h,{children:e.jsx(Kr,{})})},{path:"types/CateMainProduct/:id",element:e.jsx(h,{children:e.jsx(Xr,{})})},{path:"background",element:e.jsx(h,{children:e.jsx(Qr,{})})},{path:"background/edit/:id",element:e.jsx(h,{children:e.jsx(Zr,{})})},{path:"weeks",element:e.jsx(h,{children:e.jsx(or,{})})},{path:"week/edit/:id",element:e.jsx(h,{children:e.jsx(Sr,{})})}]},{path:"/*",element:e.jsx(lr,{})}],si=[{path:"/dashboard",name:"Admin",icon:e.jsx(ga,{})},{path:"/dashboard/products",name:"Movies",icon:e.jsx(ya,{})},{name:"User",icon:e.jsx(Le,{}),children:[{path:"/dashboard/users",name:"Users",icon:e.jsx(Z,{})},{path:"/dashboard/adminUer",name:"Admin",icon:e.jsx($e,{})}]},{name:"Category",icon:e.jsx(Le,{}),children:[{path:"/dashboard/category",name:"Category",icon:e.jsx(fa,{})},{path:"/dashboard/category/latest",name:"Latest",icon:e.jsx(we,{})}]},{name:"Themes",icon:e.jsx(nt,{}),children:[{path:"/dashboard/trailing",name:"Trailer",icon:e.jsx($e,{})},{path:"/dashboard/background",name:"Background",icon:e.jsx(ja,{})}]},{name:"Big Category",icon:e.jsx(Xe,{}),children:[{path:"/dashboard/types",name:"Types",icon:e.jsx(va,{})}]},{path:"/dashboard/comments",name:"Comments",icon:e.jsx(wa,{})},{path:"/dashboard/cart",name:"Cart",icon:e.jsx(ba,{})},{path:"/dashboard/weeks",icon:e.jsx(Ze,{}),name:"Week"}],ni=ka`
:root{
  textarea {
    outline: none;
  }
...
`,We=t=>{if(!t)return!0;try{const a=Ca(t),s=Date.now()/1e3;return a.exp<s}catch(a){return console.error("Error decoding token:",a),!0}};function ri(){const t=Qe(),a="G-0EEY3R7F0S",s=Na(ai),n=q(),[r,i]=Sa.useNotification(),l=L();return o.useEffect(()=>{Pe.initialize(a),Pe.send({hitType:"pageview",page:t.pathname,title:"User Active"}),(async()=>{if(l){const x=l.token,u=l.refreshToken;if(We(u))ft("Token expires-relogin"),localStorage.clear(),n("/signin");else if(We(x)){const m={refreshToken:l.refreshToken},{data:g}=await Xa(m);localStorage.setItem("token",JSON.stringify(g))}}})(),setTimeout(()=>{r.open({message:"Admin Xin Thông Báo!",description:"Xin lỗi, server phim hiện đang quá tải do lượng truy cập lớn. Vui lòng chờ đợi trong 1-2 phút để tiếp tục xem. Chúng tôi đang nỗ lực để cải thiện tình hình và xin thành thật xin lỗi vì sự bất tiện này.Trân trọng!",placement:"topRight"})},2e3)},[]),e.jsxs(e.Fragment,{children:[i,s,e.jsx(ni,{}),e.jsx(_a,{}),e.jsx(Aa.BackTop,{visibilityHeight:200})]})}const ii={value:{data:[],totalCount:0,totalPages:0},isLoading:!1,getOneProduct:{},getAllProductByCategory:[],status:!1},oi=M({name:"product",initialState:ii,reducers:{},extraReducers:t=>{t.addCase(Me.pending,(a,s)=>{a.isLoading=!0}).addCase(Me.fulfilled,(a,s)=>{a.isLoading=!1,a.value=s.payload}),t.addCase(an.fulfilled,(a,s)=>{a.value.data=a.value.data.filter(n=>n._id!==s.payload.data._id)}),t.addCase(sn.fulfilled,(a,s)=>{a.value.data.push(s.payload)}),t.addCase(nn.fulfilled,(a,s)=>{a.value.data.push(s.payload)}),t.addCase(rn.fulfilled,(a,s)=>{a.value.data=[...a.value.data,s.payload]}),t.addCase(ln.fulfilled,(a,s)=>{a.value.data=s.payload}),t.addCase(dn.fulfilled,(a,s)=>{a.value.data=s.payload}),t.addCase(pe.pending,(a,s)=>{a.isLoading=!0}).addCase(pe.fulfilled,(a,s)=>{a.isLoading=!1,a.getOneProduct=s.payload}),t.addCase(on.fulfilled,(a,s)=>{a.getAllProductByCategory=s.payload}),t.addCase(cn.fulfilled,(a,s)=>{a.value.data=[...a.value.data,...s.payload.data]})}}),li=oi.reducer,di={category:{data:[],length:0},isLoading:!1,isError:!1,categoryNotReqId:[],details:{}},ci=M({name:"category",initialState:di,reducers:{},extraReducers:t=>{t.addCase(U.fulfilled,(a,s)=>{a.isLoading=!1,a.category=s.payload}).addCase(U.pending,(a,s)=>{a.isLoading=!0}).addCase(U.rejected,(a,s)=>{a.isError=!0}),t.addCase(Fe.fulfilled,(a,s)=>{a.isLoading=!1,a.categoryNotReqId=s.payload}).addCase(Fe.pending,(a,s)=>{a.isLoading=!0}),t.addCase(Es.fulfilled,(a,s)=>{a.category.data=a.category.data.concat(s.payload)}),t.addCase(Rs.fulfilled,(a,s)=>{a.category.data=a.category.data.filter(n=>n._id!==s.payload._id)}),t.addCase(zs.fulfilled,(a,s)=>{a.category.data.push(s.payload)}),t.addCase(he.fulfilled,(a,s)=>{a.details=s.payload,a.isLoading=!1}).addCase(he.pending,(a,s)=>{a.isLoading=!0})}}),ui=ci.reducer,Xi=async()=>await d.get("/trailer"),se=L(),xi=async t=>await d.put(`/trailer/${t.get("_id")}/${se.user._id}`,t,{headers:{Authorization:`Bearer ${se.token}`}}),Qi=async t=>await d.post(`/background/${t.get("_id")}/${se.user._id}`,t,{headers:{Authorization:`Bearer ${se.token}`}}),mi=p("trailer/Trailing",async t=>{const{data:a}=await xi(t);return a}),hi=M({name:"post",initialState:{value:[],trailerValues:[]},reducers:{},extraReducers:t=>{t.addCase(mi.fulfilled,(a,s)=>{a.trailerValues.push(s.payload)})}}),pi=hi.reducer,ne=L(),gi=async()=>await d.get("/comments"),yi=async(t,a)=>await d.post(`/comment/${t}/${ne.user._id}`,a,{headers:{Authorization:`Bearer ${ne.token}`}}),fi=async t=>await d.post(`/comment/${ne.user._id}`,t,{headers:{Authorization:`Bearer ${ne.token}`}}),ji=p("getAllCommentSlice",async()=>{const{data:t}=await gi();return t}),vi=p("addCommentSlice",async t=>{const{data:a}=await yi(t.product,t);return a}),wi=p("deleteComment",async t=>{const{data:a}=await fi(t);return a}),bi=M({name:"comment",initialState:{value:[]},reducers:{},extraReducers:t=>{t.addCase(ji.fulfilled,(a,s)=>{a.value=s.payload}),t.addCase(vi.fulfilled,(a,s)=>{a.value.push(s.payload)}),t.addCase(wi.fulfilled,(a,s)=>{a.value=a.value.filter(n=>n._id!==s.payload._id)})}}),ki=bi.reducer,Ci=M({name:"cart",initialState:{value:[],isLoading:!1,code:null},reducers:{},extraReducers:t=>{t.addCase(Re.fulfilled,(a,s)=>{a.isLoading=!1,a.value=s.payload}).addCase(Re.pending,(a,s)=>{a.isLoading=!0}),t.addCase(ue.pending,(a,s)=>{a.isLoading=!0}).addCase(ue.fulfilled,(a,s)=>{Array.isArray(a.value)||(a.value=[]),a.isLoading=!1,a.value.push(s.payload.cart)})}}),Ni=Ci.reducer,Si={key:"root",storage:Pa,whitelist:[""],expire:"3600000"},_i=Ia({product:li,user:os,category:ui,trailer:pi,comment:ki,cart:Ni}),Ai=Ta(Si,_i),wt=La({reducer:Ai,middleware:t=>t({serializableCheck:!1})}),Ii=$a(wt);Ea.createRoot(document.getElementById("root")).render(e.jsx(Ra,{store:wt,children:e.jsx(za,{persistor:Ii,children:e.jsx(bs,{children:e.jsx(ls,{children:e.jsx(Da,{children:e.jsx(ri,{})})})})})}));export{ae as $,G as A,Li as B,ms as C,Ue as D,Be as E,vt as F,oe as G,ze as H,xn as I,as as J,Fi as K,cs as L,R as M,ht as N,De as O,jt as P,xe as Q,ns as R,mt as S,Ki as T,ss as U,Bi as V,U as W,sn as X,z as Y,W as Z,O as _,D as a,pe as a0,nn as a1,Ui as a2,rs as a3,rn as a4,Ji as a5,Ri as a6,Es as a7,Rs as a8,he as a9,zs as aa,Ss as ab,C as ac,Di as ad,Xi as ae,mi as af,ji as ag,zi as ah,wi as ai,ts as aj,pt as ak,Re as al,$i as am,Ei as an,Vi as ao,L as ap,d as aq,Oi as ar,Pi as as,Qi as at,te as b,A as c,_ as d,j as e,ir as f,Me as g,b as h,qe as i,ln as j,Mi as k,Gi as l,Yi as m,Wi as n,Y as o,B as p,cn as q,an as r,dn as s,Hi as t,I as u,qi as v,P as w,us as x,Cs as y,T as z};
