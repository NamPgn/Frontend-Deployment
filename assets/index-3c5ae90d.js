import{u as Nt,a as St,b as Je,c as p,d as F,m as M,r as o,j as e,T as _t,e as At,s as c,S as Tt,f as It,L as Ke,D as Lt,g as Pt,H as Xe,B as $t,A as Qe,R as Et,h as Rt,F as zt,W as Ot,i as Dt,k as Bt,l as Ft,P as Ze,n as Mt,C as Vt,o as Ut,p as Ht,N as we,q as qt,t as te,v as Wt,E as Gt,w as be,x as Yt,y as et,z as Te,G as Jt,I as le,J as Kt,K as tt,M as Xt,O as q,Q as Ie,U as Le,V as Qt,X as ae,Y as at,Z as Zt,_ as ue,$ as xe,a0 as st,a1 as nt,a2 as rt,a3 as Pe,a4 as ea,a5 as ta,a6 as aa,a7 as sa,a8 as it,a9 as na,aa as ra,ab as ot,ac as ia,ad as oa,ae as la,af as lt,ag as da,ah as ca,ai as dt,aj as me,ak as ua,al as ke,am as xa,an as X,ao as Q,ap as ma,aq as ha,ar as pa,as as ga,at as ya,au as $e,av as Ee,aw as fa,ax as ja,ay as va,az as wa,aA as ba,aB as ka,aC as Ca,aD as Na,aE as Sa,aF as Re,aG as _a,aH as Aa,aI as Ta,aJ as Ia,aK as La,aL as Pa,aM as $a,aN as Ea,aO as Ra,aP as za,aQ as Oa}from"./vendor-96c022cb.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function s(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(n){if(n.ep)return;n.ep=!0;const i=s(n);fetch(n.href,i)}})();const Da="modulepreload",Ba=function(t){return"/"+t},ze={},v=function(a,s,r){if(!s||s.length===0)return a();const n=document.getElementsByTagName("link");return Promise.all(s.map(i=>{if(i=Ba(i),i in ze)return;ze[i]=!0;const l=i.endsWith(".css"),x=l?'[rel="stylesheet"]':"";if(!!r)for(let y=n.length-1;y>=0;y--){const j=n[y];if(j.href===i&&(!l||j.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${x}`))return;const m=document.createElement("link");if(m.rel=l?"stylesheet":Da,l||(m.as="script",m.crossOrigin=""),m.href=i,document.head.appendChild(m),l)return new Promise((y,j)=>{m.addEventListener("load",y),m.addEventListener("error",()=>j(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>a()).catch(i=>{const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i})},T=()=>{const t=localStorage.getItem("token");if(t)return JSON.parse(t||"")},V=()=>Nt(),A=St,d=Je.create({baseURL:"https://node-6-jbbj.onrender.com/api"}),Fa=Je.create({baseURL:"https://node-6-jbbj.onrender.com/api"}),H=T(),Ma=async t=>await d.post("/signup",t),Va=async t=>await d.post("/signin",t),ct=async()=>await d.get("user"),Ua=async t=>await d.get("user_one/"+t),Ha=async t=>await d.delete("removeUser/"+t+`/${H.user._id}`,{headers:{Authorization:`Bearer ${H.token}`}}),qa=async t=>await d.put(`user/${t._id}/${H.user._id}`,t,{headers:{Authorization:`Bearer ${H.token}`}}),Wa=async t=>await d.post("user/creating",t),Ga=async t=>await d.get(`user/cart/${t}`),Ya=async(t,a)=>await d.post(`/user/upload/${t}`,a,{headers:{Authorization:`Bearer ${H.token}`}}),Ja=async t=>await d.post("/forgot-password",t),Ka=async(t,a,s)=>await d.post(`/reset-password/${t}/${a}`,s),Xa=async t=>await d.post("/refreshToken",t),se=T(),Qa=async()=>await d.get("/cart"),Za=async t=>await d.post(`/cart/${se.user._id}`,t,{headers:{Authorization:`Bearer ${se.token}`}}),es=async(t,a)=>await d.post(`/cart/${t}/${se.user._id}`,a,{headers:{Authorization:`Bearer ${se.token}`}}),Oe=p("cartSlice",async()=>{const{data:t}=await Qa();return t}),he=p("addCartSlice",async t=>{const{data:a}=await Za(t);return a}),ts=p("deleteCartSlice",async t=>{const{data:a,status:s}=await es(t.id,t);return a.data}),De=p("user/login",async t=>{const{data:a}=await Ma(t);return a}),ce=p("user/signin",async t=>{const{data:a,status:s}=await Va(t);return a}),as=p("user/getAll",async()=>{const{data:t}=await ct();return t.filter(s=>s.role==0)}),pe=p("user/getUser_id",async t=>{const{data:a}=await Ua(t);return a}),ss=p("admin/getAdmin",async()=>{const{data:t}=await ct();return t.filter(s=>s.role>=1)}),Be=p("user/deteleUser",async t=>{const{data:a}=await Ha(t);return a}),ns=p("edit/editUser",async t=>{const{data:a}=await qa(t);return a}),rs=p("user/importXlsx",async t=>{const{data:a}=await Wa(t);return a}),Fe=p("findcart",async t=>{const{data:a}=await Ga(t);return a.cart}),Me=p("uploadImage",async({id:t,formData:a})=>{const{data:s,status:r}=await Ya(t,a);return s}),ut=F({name:"user",initialState:{value:[],cartUser:[],isLoading:!1,error:!1,login:{},isLogin:localStorage.getItem("isLogin")==="true",user:{}},reducers:{logout(t){localStorage.removeItem("token"),M.success("Logout successful!"),t.isLogin=!1,localStorage.setItem("isLogin","false"),t.user={}}},extraReducers:t=>{t.addCase(De.fulfilled,(a,s)=>{a.error=!1,a.value=s.payload.newUser}).addCase(De.rejected,(a,s)=>{a.error=!0}),t.addCase(ce.pending,(a,s)=>{a.isLoading=!0}).addCase(ce.fulfilled,(a,s)=>{localStorage.setItem("token",JSON.stringify(s.payload)),a.login=s.payload,a.error=!1,a.isLogin=!0,a.isLoading=!1,a.user=s.payload.user,localStorage.setItem("isLogin","true")}).addCase(ce.rejected,(a,s)=>{a.error=s.payload,a.isLoading=!1}),t.addCase(as.fulfilled,(a,s)=>{a.value=s.payload}),t.addCase(Be.fulfilled,(a,s)=>{a.value=a.value.filter(r=>r._id!==s.payload._id)}).addCase(Be.rejected,(a,s)=>{}),t.addCase(ss.fulfilled,(a,s)=>{a.value=s.payload}),t.addCase(ns.fulfilled,(a,s)=>{a.value.push(s.payload)}),t.addCase(rs.fulfilled,(a,s)=>{a.value.unshift(s.payload)}),t.addCase(Fe.pending,(a,s)=>{a.isLoading=!0}).addCase(Fe.fulfilled,(a,s)=>{a.isLoading=!1,a.cartUser=s.payload}),t.addCase(pe.fulfilled,(a,s)=>{a.user=s.payload,a.isLoading=!1}).addCase(pe.pending,(a,s)=>{a.isLoading=!0}),t.addCase(Me.fulfilled,(a,s)=>{a.isLoading=!1,a.user=s.payload.data}).addCase(Me.pending,(a,s)=>{a.isLoading=!0}),t.addCase(ts.fulfilled,(a,s)=>{const r=a.user.cart.filter(n=>n.product._id!==s.payload.product);a.user.cart=r})}}),{logout:is}=ut.actions,os=ut.reducer,Z=T(),$=o.createContext(null),ls=t=>{const a=V(),{user:s}=A(j=>j.user),r=localStorage.getItem("isLogin"),n=A(j=>j.user.isLogin),[i,l]=o.useState(!1),[x,u]=o.useState(!1),m=()=>{u(!x)};o.useEffect(()=>{Z&&a(pe(Z.user._id))},[n,a,i]);const y={Auth:Z||"",user:s,isLoggedIn:r,isLoggedInState:n,setReset:l,handleClick:m,state:x};return e.jsx($.Provider,{value:y,children:t.children})},k=o.memo(({level:t,children:a,...s})=>e.jsx(_t,{...s,children:a})),ne=({color:t,children:a,...s})=>e.jsx(At,{color:t,...s,children:a}),ds=c.div`
height: 100vh;
`,xt=c.div`
position: relative;
height: 100vh;
...
`,Us=o.memo(()=>{const{data:t,isError:a}=L(P+"/trailer"),{state:s}=o.useContext($);return a?e.jsx(us,{}):e.jsxs("div",{className:s?"p-3":"mt-3",children:[e.jsxs("div",{className:"d-flex",children:[e.jsx("div",{className:"lg:w-9/12 md:w-12/12 sm:w-full",children:e.jsxs("div",{className:"h-full",children:[e.jsx(Vs,{className:"relative md:mx-2",children:e.jsx(Ms,{className:"h-full absolute bg-black rounded",width:"100%",loop:!0,muted:!0,autoPlay:!0,controls:!0,src:t==null?void 0:t.url})}),e.jsx(Fs,{})]})}),e.jsx(gs,{})]}),e.jsx(Ss,{}),e.jsx(jt,{children:e.jsx(ft,{})})]})}),Ce=({ogTitle:t,description:a,imageUrl:s,mainTitle:r,title:n,...i})=>e.jsxs(Ht,{children:[e.jsx("title",{children:n}),e.jsx("meta",{property:"og:title",content:t}),e.jsx("meta",{property:"og:description",content:a}),e.jsx("meta",{property:"og:image",content:s}),Object.keys(i).map(l=>e.jsx("meta",{...i[l]},l))]}),Hs=()=>e.jsxs(e.Fragment,{children:[e.jsx(Ce,{ogTitle:"Hoạt Hình Trung Quốc",description:"Đấu Phá Thương Khung Phần 5",imageUrl:E(200,"https://res.cloudinary.com/daz3lejjo/image/upload/w_100/v1721825684/category/category_1689076028777-a6e7592292d5428b1bc4.jpg.jpg"),title:"Hoạt Hình 3D"}),e.jsx(Us,{})]}),b=T(),qs=async t=>await d.get(`products?page=${t}`),Ws=async t=>await d.get(`product/${t}`),Gs=async t=>await d.delete(`/product/${t}/${b.user._id}`,{headers:{Authorization:`Bearer ${b.token}`}}),Ys=async t=>await d.post(`/product/${b.user._id}`,t,{headers:{Authorization:`Bearer ${b.token}`}}),Js=async t=>await d.put(`/product/${t.get("_id")}/${b.user._id}`,t,{headers:{Authorization:`Bearer ${b.token}`}}),Ks=async t=>await d.post("/products/creating",t,{}),Di=async t=>await d.post(`/products/deleteMultiple/${b.user._id}`,t,{headers:{Authorization:`Bearer ${b.token}`}}),Xs=async t=>await d.get(`/category/products/${t}`),Bi=async(t,a)=>await d.post(`/product/pushlist/${t}/${b.user._id}`,a,{headers:{Authorization:`Bearer ${b.token}`}}),Fi=async(t,a)=>await Fa.post(`/product/abyss/${t}/${b.user._id}`,a,{headers:{Authorization:`Bearer ${b.token}`}}),Mi=async t=>await d.post(`/product/approve/${t}/${b.user._id}`,null,{headers:{Authorization:`Bearer ${b.token}`}}),Vi=async t=>await d.post(`/product/approve/cancel/${t}/${b.user._id}`,null,{headers:{Authorization:`Bearer ${b.token}`}}),Qs=async t=>await d.get(`/product/filter?c=${t}`),Zs=async t=>await d.get(`/product/v?name=${t}`),Ui=async()=>await d.post(`/products/clear/${b.user._id}`,null,{headers:{Authorization:`Bearer ${b.token}`}}),Hi=async t=>await d.post(`/products/approvedMultiple/${b.user._id}`,t,{headers:{Authorization:`Bearer ${b.token}`}}),qi=async t=>await d.post(`/products/encodeMultipleDailymotionServer/${b.user._id}`,t,{headers:{Authorization:`Bearer ${b.token}`}}),Ue=p("product/getProducts",async t=>{const{data:a}=await qs(t);return a}),fe=p("product/getProduct",async t=>{const{data:a}=await Ws(t);return a}),en=p("product/deleteProduct",async t=>{const{data:a}=await Gs(t);return a}),tn=p("product/addProduct",async t=>{const{data:a,status:s}=await Ys(t);return a}),an=p("product/editProduct",async t=>{const{data:a}=await Js(t);return a}),sn=p("product/importDataFile",async t=>{const{data:a}=await Ks(t);return a}),vt=p("product/getAllProductDataByCategory",async t=>{const{data:a}=await Xs(t);return a}),nn=p("product/filter",async t=>{const{data:a}=await Qs(t);return a}),rn=p("product/Search",async t=>{const{data:a}=await Zs(t);return a}),on=t=>t.product.getOneProduct,ln=t=>t.product.getAllProductByCategory,Wi=t=>t.category.category,dn=t=>t.user.value,Gi=t=>t.user.value,cn=c.button`
